...
-- https://www.youtube.com/watch?v=I3YvjFfn478&list=PLbTF1OfX62c3RQ_ZFfyNBWVPdz_OWTMLG&index=25&ab_channel=AshutoshKumar
-- https://www.youtube.com/watch?v=RY4npAVNSfc&ab_channel=AshutoshKumar

SELECT [District],[State],[Growth],[Sex_Ratio],[Literacy] FROM [Projeto_SQL_Censo].[dbo].[Data1] -- 640 linhas
-- Nome das colunas: Distrito, Estado, Crescimento, Proporção sexual e Alfabetização
SELECT [District],[State],[Area_km2],[Population] FROM [Projeto_SQL_Censo].[dbo].[Data2] -- 640 linhas
-- Nome das colunas: Distrito, Estado, Área e População

SELECT 
	DISTINCT([State]) as 'Estado', 
	DISTINCT([District]) as 'Distrito'
FROM [Projeto_SQL_Censo].[dbo].[Data1] -- 35 estados distintos e 634 distritos 

SELECT DISTINCT([State]) FROM [Projeto_SQL_Censo].[dbo].[Data2] -- 34 estados distintos

-- população da Índia

SELECT sum(population) as 'Total População' from project..data2
