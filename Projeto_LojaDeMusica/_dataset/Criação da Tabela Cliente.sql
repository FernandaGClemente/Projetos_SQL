/****** Script dos comandos do SQL para a CriaÁ„o da Tabela Cliente ******/
...
(1,'Lua','GonaÁalves','Embraer - Empresa Brasileira de Aerona°utica S.A.','Av. Brigadeiro Faria Lima, 2170','Sa£o Josa© dos Campos','SP','Brazil','12227-000','+55 (12) 3923-5555','+55 (12) 3923-5566','luisg@embraer.com.br',3),
(2,'Leonie','Kahler','','Theodor-Heuss-Straaüe 34','Stuttgart','','Germany','70174','+49 0711 2842222','','leonekohler@surfeu.de',5),
(3,'FranaÁois','Tremblay','','1498 rue Ba©langer','Montra©al','QC','Canada','H2G 1A7','+1 (514) 721-4711','','ftremblay@gmail.com',3),
(4,'Bjarn','Hansen','','Ulleva•lsveien 14','Oslo','','Norway','171','+47 22 44 22 22','','bjorn.hansen@yahoo.no',4),
(5,'Frantianek','Wichterlova°','JetBrains s.r.o.','Klanova 9/506','Prague','','Czech Republic','14700','+420 2 4172 5555','+420 2 4172 5555','frantisekw@jetbrains.com',4),
(6,'Helena','Hola','','Rilska° 3174/6','Prague','','Czech Republic','14300','+420 2 4177 0449','','hholy@gmail.com',5),
(7,'Astrid','Gruber','','Rotenturmstraaüe 4, 1010 Innere Stadt','Vienne','','Austria','1010','+43 01 5134505','','astrid.gruber@apple.at',5),
(8,'Daan','Peeters','','Gra©trystraat 63','Brussels','','Belgium','1000','+32 02 219 03 03','','daan_peeters@apple.be',4),
(9,'Kara','Nielsen','','Sa∏nder Boulevard 51','Copenhagen','','Denmark','1720','+453 3331 9991','','kara.nielsen@jubii.dk',4),
(10,'Eduardo','Martins','Woodstock Discos','Rua Dr. Falca£o Filho, 155','Sa£o Paulo','SP','Brazil','01007-010','+55 (11) 3033-5446','+55 (11) 3033-4564','eduardo@woodstock.com.br',4),
(11,'Alexandre','Rocha','Banco do Brasil S.A.','Av. Paulista, 2022','Sa£o Paulo','SP','Brazil','01310-200','+55 (11) 3055-3278','+55 (11) 3055-8131','alero@uol.com.br',5),
(12,'Roberto','Almeida','Riotur','Praaßa Pio X, 119','Rio de Janeiro','RJ','Brazil','20040-020','+55 (21) 2271-7000','+55 (21) 2271-7070','roberto.almeida@riotur.gov.br',3),
(13,'Fernanda','Ramos','','Qe 7 Bloco G','Brasa≠lia','DF','Brazil','71020-677','+55 (61) 3363-5547','+55 (61) 3363-7855','fernadaramos4@uol.com.br',4),
...
(34,'Joa£o','Fernandes','','Rua da Assunaßa£o 53','Lisbon','','Portugal','','+351 (213) 466-111','','jfernandes@yahoo.pt',4),
(35,'Madalena','Sampaio','','Rua dos Campeaµes Europeus de Viena, 4350','Porto','','Portugal','','+351 (225) 022-448','','masampaio@sapo.pt',4),
(36,'Hannah','Schneider','','Tauentzienstraaüe 8','Berlin','','Germany','10789','+49 030 26550280','','hannah.schneider@yahoo.de',5),
(37,'Fynn','Zimmermann','','Berger Straaüe 10','Frankfurt','','Germany','60316','+49 069 40598889','','fzimmermann@yahoo.de',3),
(38,'Niklas','Schrader','','Barbarossastraaüe 19','Berlin','','Germany','10779','+49 030 2141444','','nschroder@surfeu.de',3),
...
(44,'Terhi','Ha§ma§la§inen','','Porthaninkatu 9','Helsinki','','Finland','530','+358 09 870 2000','','terhi.hamalainen@apple.fi',3),
(45,'Ladislav','Kova°cs','','Erzsa©bet krt. 58.','Budapest','','Hungary','H-1073','','','ladislav_kovacs@apple.hu',3),
...
(49,'Stanis≈Çaw','Wajcik','','Ordynacka 10','Warsaw','','Poland','00-358','+48 22 828 37 39','','stanis≈Çaw.w√≥jcik@wp.pl',4),
(50,'Enrique','Mua±oz','','C/ San Bernardo 85','Madrid','','Spain','28015','+34 914 454 454','','enrique_munoz@yahoo.es',5),
...
(56,'Diego','Gutiarrez','','307 Macacha Gaºemes','Buenos Aires','','Argentina','1106','+54 (0)11 4311 4333','','diego.gutierrez@yahoo.ar',4),
